...
class Pda_Admin {
    ...
    function __construct() {
        ...
        add_action( 'upgrader_process_complete', 'create_new_table_and_migrate_data',10, 2);
    ...
    public function check_protected_file ($id) {
        ...
        if (isset($protected_file) && $protected_file->is_prevented === "1") {
            return '<i class="dashicons dashicons-yes protected_yes"></i>';
        } else {
            return '<i class="dashicons dashicons-no protected_no"></i>';
        }
    }
    ...
    public function pda_add_settings_page() {
        ...
        add_submenu_page( 'wp_pda_options', __('Settings', 'prevent-direct-access'), __('Settings', 'prevent-direct-access'), 'manage_options', 'wp_pda_options',  array($this, 'pda_options_do_page'), 'dashicons-hidden');
